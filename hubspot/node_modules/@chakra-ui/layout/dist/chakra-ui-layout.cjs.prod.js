...
var Mark = /*#__PURE__*/system.forwardRef(function (props, ref) {
  var styles = system.useStyleConfig("Mark", props);
...
function Highlight(props) {
  ...
  return /*#__PURE__*/React__namespace["default"].createElement(React__namespace["default"].Fragment, null, chunks.map(function (chunk, index) {
    return chunk.match ? /*#__PURE__*/React__namespace["default"].createElement(Mark, {
      sx: styles
    }, chunk.text) : /*#__PURE__*/React__namespace["default"].createElement(React.Fragment, {
      key: index
    }, chunk.text);
  }));
}
...
var _createStylesContext = system.createStylesContext("List"),
...
function widthToColumns(width, theme) {
  return utils.mapResponsive(width, function (value) {
    var _value = system.getToken("sizes", value, toPx(value))(theme);
