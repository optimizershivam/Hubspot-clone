...
function getColorModeUtils(options) {
  ...
  var utils$1 = {
    setDataset: function setDataset(value) {
      var cleanup = preventTransition ? utils$1.preventTransition() : undefined;
    ...
    getSystemTheme: function getSystemTheme(fallback) {
      ...
      var dark = (_utils$query$matches = utils$1.query().matches) != null ? _utils$query$matches : fallback === "dark";
      return dark ? "dark" : "light";
    },
    addListener: function addListener(fn) {
      var mql = utils$1.query();

      var listener = function listener(e) {
        fn(e.matches ? "dark" : "light");
      };

      if (utils.isFunction(mql.addListener)) mql.addListener(listener);else mql.addEventListener("change", listener);
      return function () {
        if (utils.isFunction(mql.removeListener)) mql.removeListener(listener);else mql.removeEventListener("change", listener);
      };
    },
